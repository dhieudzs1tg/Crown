...
module.exports.run = async({ api,
    ...
    var msg = `»𝗧𝗛𝗢̂𝗡𝗚 𝗕𝗔́𝗢 𝗔𝗗𝗠𝗜𝗡 « \n→ 𝗡𝗼̛𝗶 𝗚𝘂̛̉𝗶: ${event.isGroup == true ? 'Nhóm ' + global.data.threadInfo.get(event.threadID).threadName: 'Từ cuộc trò chuyện riêng với bot'}\n→ 𝗔𝗗𝗠𝗜𝗡: ${(await Users.getData(sid)).name}
→ 𝗧𝗶𝗺𝗲: ${fullTime()}
━━━━━━━━━━━━
→ 𝗡𝗼̣̂𝗶 𝗗𝘂𝗻𝗴: \n━━━━━━━━━━━━\n${content}\n━━━━━━━━━━━━\n ━━━━━━━━━━━━
→ 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘃𝗲̀ 𝗔𝗗𝗠𝗜𝗡\n➩ Người gửi : fb.com/${event.senderID}`
