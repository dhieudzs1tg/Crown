...
module.exports.run = async o => {
  ...
  for (let i = 0; i < 5; i++) {
    text += `\n${i+1}-> ${bokk[i].day} ${bokk[i].date}\n=>🌡️Nhiệt độ dự báo: từ ${bokk[i].low} đến ${bokk[i].high}\n=>☁️Mô tả: ${bokk[i].skytextday}\n=>🌦️Tỷ lệ mưa: ${bokk[i].precip}\n`
  };
