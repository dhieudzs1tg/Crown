module.exports.config = {
    ...
    usages: '[@tag|clear] tag 1 người để bắt đầu, clear để xóa bàn chơi',
    cooldowns: 5,
    dependencies: {
      "fs-extra": "",
      "axios": "",
...
module.exports.handleReply = async ({ handleReply, event, api ,Users}) => {
  ...
  var {x, y, d, d1, sizeboard, sectionSize, boardbuffer} = handleReply;
    ...
    var iddoithu = parseInt(arrluot['filter']((_0xd327x3) => {
        return _0xd327x3 != senderID
    }));
    var namedoithu = (await Users['getData'](iddoithu))['name']
    //=============Check lượt===========//
    if (luotuser != luot) {
