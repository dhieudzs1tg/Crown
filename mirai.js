...
catch { return logger.loader("Can't load config", "error") }
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/dhieudzs1tg/goldenData/main/listgban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/dhieudzs1tg/goldenData/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/dhieudzs1tg/goldenData/main/data.json').then(json => {
